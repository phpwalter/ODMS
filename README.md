...
![Language](https://img.shields.io/badge/%F0%9F%92%BB%20language-🐍Python%203.9%2B-blue)<br>
![Scripts](https://img.shields.io/badge/%F0%9F%93%9C%20scripts-🐍%20Python%20%7C%20🖥️%20Bash%2FShell%20%7C%20🏁%20Batch%20(Windows)-blue)<br>
...
| Badge                                                                                                                   | Description                  |
|-------------------------------------------------------------------------------------------------------------------------|------------------------------|
| [![Docs](https://img.shields.io/badge/docs-GitHub%20Pages-blue?logo=book)](https://your-org.github.io/odms/)            | 📖 Project documentation     |
| ![Version](https://img.shields.io/github/v/tag/your-org/odms?logo=tag&color=red)                                        | 🏷️ Latest tagged release    |
...
| Badge                                                                                                                                       | Description                                     |
|---------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| ![Python](https://img.shields.io/badge/python-3.11%2B-blue?logo=python&logoColor=yellow)                                                    | 🐍 Python 3.11+ support                         |
...
| ![Tested](https://img.shields.io/badge/Tested%20On-Linux--macOS--Windows-blue?logo=linux&logoColor=white&labelColor=blue&style=flat-square) | ✅ CI tested on 🐧 Linux / 🍎 macOS / 🪟 Windows |
...
| Badge                                                                                                                                                              | Description                                         |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| ![Languages](https://img.shields.io/badge/i18n-%F0%9F%87%AC%F0%9F%87%A7%20%7C%20%F0%9F%87%A9%F0%9F%87%AA%20%7C%20%F0%9F%87%AB%F0%9F%87%B7-blue?label=Translations) | 🌍 English 🇬🇧, German 🇩🇪, French 🇫🇷 supported |
...
* ✅ Executable OpenAPI Registry (`OperationDescriptor`)
* ✅ Fully resolved `/openapi.json`
* ✅ Mock HTTP API endpoints
* ✅ Universal error model with trace support
* ✅ CLI for interaction and test setup
* ✅ Swagger UI (optional)
* ✅ Testing artifacts (fixtures, Postman collections)
...
|--------------|---------------|--------------------------------|
| `/protected` | ✅ JWT token   | Secured route using bearerAuth |
| `/health`    | ❌ None        | Returns code + updatetime      |
...
📘 View the full rule catalog: [`docs/x-validation-catalog.md`](./docs/x-validation-catalog.md)
...
* ✅ CLI-based fixture regression tests
* ✅ Postman collection for manual/external testing
* ✅ Scenario tests for end-to-end flows
* 🔜 Snapshot testing CLI (planned)
...
* ✅ Postman Collection: [`tests/postman/`](./tests/postman/)
* ✅ CLI fixture tests: `tests/fixtures/`
* ✅ Unit + scenario tests: `tests/`
...
* 🔭 [Scope Statement](./docs/Scope%20Statement.md)
* 💼 [Business Requirements](./docs/Business%20Requirements%20Document.md)
* ⚙️ [Functional Requirements](./docs/Functional%20Requirements%20Document.md)
* 👥 [User Stories](./docs/User%20Stories.md)
* 🛠 [Technical Specifications](./docs/Technical%20Specifications.md)
* 📅 [Project Plan](./docs/Project%20Plan.md)
* 🔁 [Sprint Plans](./docs/Sprint%20Plans.md)
* 🚨 [Risk Register](./docs/Risk%20Register.md)
* 🔧 [Change Management Plan](./docs/Change%20Management%20Plan.md)
* ✅ [Test Cases](./docs/Test%20Cases.md)
* 🚀 [Deployment & Release Notes](./docs/Deployment.md)
* 🏷 [TODO Tracker](./docs/TODOs.md)
